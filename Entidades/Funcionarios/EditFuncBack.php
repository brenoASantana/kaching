...
if ($id == null || $nome == null || $email == null || $data_nascimento == null || $cpf == null || $endereco == null || $bairro == null || $id_estados == "" || $id_cargo == null || $ativo == null) {
	echo "<script language='javascript' type='text/javascript'>alert('Preencha todos os campos corretamente!');window.location.href='../../painelAdmin.php?menu=funcEdit'</script>";
} else {
	...
	if ($conn->query($sql) === TRUE) {
		echo "<script language='javascript' type='text/javascript'>alert('Cadastro alterado com sucesso!');window.location.href='../../painelAdmin.php?menu=funcEdit'</script>";
	} else {
