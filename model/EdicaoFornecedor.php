...
if ($id == null || $razao_social == null || $nome_fantasia == null || $cnpj == null || $representante == null || $email == null || $endereco == null || $bairro == null || $id_estados == null || $atividade == null) {
	echo "<script language='javascript' type='text/javascript'>alert('Preencha todos os campos corretamente!');window.location.href='../controller/PainelAdmin.php?menu=fornEdit'</script>";
} else {
	...
	if ($conn->query($sql) === TRUE) {
		echo "<script language='javascript' type='text/javascript'>alert('Cadastro alterado com sucesso!');window.location.href='../controller/PainelAdmin.php?menu=fornEdit'</script>";
	} else {
