...
if ($id_produto == null || $produto == null || $codigo == null || $categoria == null || $sub_categoria == null || $fornecedor == null) {
	echo "<script language='javascript' type='text/javascript'>alert('Preencha todos os campos corretamente!');window.location.href='../controller/PainelAdmin.php?menu=prodEdit'</script>";
} else {
	...
	if ($conn->query($sql) === TRUE) {
		echo "<script language='javascript' type='text/javascript'>alert('Cadastro alterado com sucesso!');window.location.href='../controller/PainelAdmin.php?menu=prodEdit'</script>";
	} else {
